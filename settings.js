...
module.exports = {
SESSION_ID: process.env.SESSION_ID |malvin~wq1kzabQ#VaOWTagQ8z4AHOBhJmNQPd39ZlKqBwR6Nl1sUGXhLh8| "",
// add your Session Id make sure it starts with malvin~
PREFIX: process.env.PREFIX || ".",
// add your prifix for bot   
BOT_NAME: process.env.BOT_NAME || "SHAKOOR X BOT",
...
// automatic delete links witho remove member 
          ...
          OWNER_NUMBER: process.env.OWNER_NUMBER || "923424220027",
// add your bot owner number

OWNER_NAME: process.env.OWNER_NAME || "SHAKOOR X BADBOY",
// add bot owner name
...
// true if want mark commands as read 
     ...
     DEV: process.env.DEV || "923424220027",
